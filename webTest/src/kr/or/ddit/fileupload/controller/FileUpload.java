...
/*
- Servlet 3.0이상에서 파일 업로드를 하려면 서블릿에 @MutipartConfig
  애노테이션을 설정해야 한다.
...
public class FileUpload extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// GET방식으로 요청하면 fileUploadForm.jsp으로 forwarding한다.
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		2. getPart(String name) ==> 지정된 이름을 갖는 개별 Part객체를 반환한다.
		
		- Part객체에서 제공하는 메서드
		1. getInputStream() ==> Part 에 대한 InputStream을 반환한다.
								(데이터를 직접 추출할 때 사용한다.)
	...
	---------------------sdlk290847sdh2398   ==> Part를 구분하는 구분선
